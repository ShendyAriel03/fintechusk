                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <form action="{{ route('request_topup') }}" method="POST">
                                    ...
                                    <td><button type="submit" class="btn btn-danger">SETUJU</button></td>
                                </form>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="col-md-12">
            <div class="container mb-3">
                <div class="text-center">
                    ...
                    <div class="row text-bg-danger p-3" style="height: 170px;">
                        <div class="col">
                            <div class="row">
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-danger">Top Up Sekarang</button>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="row justify-content-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                <div class="d-grip gap-2">
                                                    <button type="submit" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-header text-bg-danger fw-bold text-center">
                    Keranjang
                </div>
                <div class="card-body">
                    <ul>
            ...
            <div class="card mb-3">
                <div class="card-header text-center fw-bold text-bg-danger">
                    Mutasi Wallet
                </div>
